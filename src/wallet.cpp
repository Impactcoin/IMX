...
// impact: total coins staked (non-spendable until maturity)
...
// impact: get current stake weight
...
// impact: check 'spent' consistency between wallet and txindex
// impact: fix wallet spent state according to txindex
...
// impact: disable transaction (only for coinstake)
